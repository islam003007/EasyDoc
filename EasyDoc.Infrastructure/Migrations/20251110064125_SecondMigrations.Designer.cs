...
namespace EasyDoc.Infrastructure.Migrations
{
    ...
    [Migration("20251110064125_SecondMigrations")]
            ...
            modelBuilder.Entity("EasyDoc.Domain.Entities.DoctorAggregate.Doctor", b =>
                {
                    ...
                    b.HasOne("EasyDoc.Infrastructure.Data.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("EasyDoc.Domain.Entities.DoctorAggregate.Doctor", "IdentityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("EasyDoc.Domain.Entities.PatientAggregate.Patient", b =>
                {
                    b.HasOne("EasyDoc.Infrastructure.Data.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("EasyDoc.Domain.Entities.PatientAggregate.Patient", "IdentityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

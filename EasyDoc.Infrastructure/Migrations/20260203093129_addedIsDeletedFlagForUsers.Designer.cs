...
namespace EasyDoc.Infrastructure.Migrations
{
    ...
    [Migration("20260203093129_addedIsDeletedFlagForUsers")]
    partial class addedIsDeletedFlagForUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyDoc.Application.Abstractions.Data.UserReadModel", b =>
                {
                    ...
                    b.ToView("vw_user_read", (string)null);
                });
            ...
            modelBuilder.Entity("EasyDoc.Domain.Entities.DoctorAggregate.Doctor", b =>
                {
                    ...
                    b.Property<string>("MetaphoneKeys")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("CityId", "DepartmentId")
                        .HasFilter("[IsVisible] = 1");

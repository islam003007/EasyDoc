...
/*
 * DoubleMetaphone Implementation Source: 
 * Derived from the MongoDB.Entities project, available at 
 * https://github.com/dj-nitehawk/MongoDB.Entities
 * * Original Author/Copyright: Copyright (c) 2019 Đĵ ΝιΓΞΗΛψΚ
 * Original License: MIT License
 * * This file is used under the terms of the original permissive MIT license.
 * For full legal compliance, the complete MIT License text must be 
 * included in the project's documentation (e.g., in a THIRD-PARTY LICENSES file).
*/
...
internal static class DoubleMetaphone
{
    ...
    private static readonly string[] Y_ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = ["Y", "ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", "ER"];
    ...
    private static bool Match(string stringRenamed, int pos, IReadOnlyList<string> strings)
    {
